...
import Transfer_admin from './admin/transfer_admin'
...
function AdminRoutes() {
    const [current, setCurrent] = useState('admin-home')
    ...
    return (
        <div className="row m-3" style={{ minHeight: '80vh' }}>
            <Menu className='col-md-2' defaultSelectedKeys={['admin-home']}>
                <Item key='admin-home' onClick={(e) => setCurrent(e.key)} style={{ display: "flex", justifyContent: 'space-around' }}>
                ...
                <Item key='admin-user' onClick={(e) => setCurrent(e.key)} style={{ display: "flex", justifyContent: 'space-around' }} >
                    <svg className='m-2' xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people" viewBox="0 0 16 16">
                ...
                <Item key='admin-transfer' onClick={(e) => setCurrent(e.key)} style={{ display: "flex", justifyContent: 'space-around' }}>
            ...
            <div className="col-md-10">
                ...
                {current === 'admin-home' && <Home_admin />}
                {current === 'admin-user' && <Users_admin />}
                {current === 'admin-transfer' && <Transfer_admin />}
